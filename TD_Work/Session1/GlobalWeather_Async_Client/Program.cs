using GlobalWeather.ServiceReferenceGlobalWeather;
using System;
...
namespace GlobalWeather
{
    class Program
    {
        ...
        {
            {
                try
                {
                    ...
                    // set a string to the results of the weather query
                    // use await to hold here for the results to be returned to the string variable
                    // This service seems permanently dead
        ...
        static async void GetCitiesByCountry(string country)
        {
            {
                try
                {
